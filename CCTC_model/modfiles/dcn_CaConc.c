...
#define nrn_init _nrn_init__dcnCaConc
#define _nrn_initial _nrn_initial__dcnCaConc
#define nrn_cur _nrn_cur__dcnCaConc
#define _nrn_current _nrn_current__dcnCaConc
#define nrn_jacob _nrn_jacob__dcnCaConc
#define nrn_state _nrn_state__dcnCaConc
#define _net_receive _net_receive__dcnCaConc 
#define states states__dcnCaConc 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_dcnCaConc", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define caiBase caiBase_dcnCaConc
 double caiBase = 5e-005;
#define tauCa tauCa_dcnCaConc
 double tauCa = 70;
 ...
 "tauCa_dcnCaConc", "ms",
 "caiBase_dcnCaConc", "mM",
 "kCa_dcnCaConc", "1/coulomb",
 "depth_dcnCaConc", "micron",
 0,0
};
 ...
 "tauCa_dcnCaConc", &tauCa_dcnCaConc,
 "caiBase_dcnCaConc", &caiBase_dcnCaConc,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 dcnCaConc D:/Projects/SchreglmannEtAl2020/CCTC_model/modfiles/dcn_CaConc.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "dcn_CaConc.mod";
static const char* nmodl_file_text = 
