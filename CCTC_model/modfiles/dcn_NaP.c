...
#define nrn_init _nrn_init__dcnNaP
#define _nrn_initial _nrn_initial__dcnNaP
#define nrn_cur _nrn_cur__dcnNaP
#define _nrn_current _nrn_current__dcnNaP
#define nrn_jacob _nrn_jacob__dcnNaP
#define nrn_state _nrn_state__dcnNaP
#define _net_receive _net_receive__dcnNaP 
#define _f_rate _f_rate__dcnNaP 
#define rate rate__dcnNaP 
#define states states__dcnNaP 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_dcnNaP", _hoc_setdata,
 "rate_dcnNaP", _hoc_rate,
 0, 0
};
...
#define qdeltat qdeltat_dcnNaP
 double qdeltat = 1;
#define usetable usetable_dcnNaP
 double usetable = 1;
 ...
 "qdeltat_dcnNaP", &qdeltat_dcnNaP,
 "usetable_dcnNaP", &usetable_dcnNaP,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 dcnNaP D:/Projects/SchreglmannEtAl2020/CCTC_model/modfiles/dcn_NaP.mod\n");
...
static int  _f_rate ( _threadargsprotocomma_ double _lv ) {
   if ( fabs ( _lv + 70.0 ) < 1e-6 ) {
     minf = 1.0 / ( 1.0 + exp ( ( _lv + 70.00001 ) / - 4.1 ) ) ;
     }
   else {
...
#if NMODL_TEXT
static const char* nmodl_filename = "dcn_NaP.mod";
static const char* nmodl_file_text = 
