...
#define nrn_init _nrn_init__dcnh
#define _nrn_initial _nrn_initial__dcnh
#define nrn_cur _nrn_cur__dcnh
#define _nrn_current _nrn_current__dcnh
#define nrn_jacob _nrn_jacob__dcnh
#define nrn_state _nrn_state__dcnh
#define _net_receive _net_receive__dcnh 
#define _f_rate _f_rate__dcnh 
#define rate rate__dcnh 
#define states states__dcnh 
...
#define qdeltat qdeltat_dcnh
 double qdeltat = 1;
#define usetable usetable_dcnh
 double usetable = 1;
 ...
 "qdeltat_dcnh", &qdeltat_dcnh,
 "usetable_dcnh", &usetable_dcnh,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 dcnh D:/Projects/SchreglmannEtAl2020/CCTC_model/modfiles/dcn_h.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "dcn_h.mod";
static const char* nmodl_file_text = 
