...
#define nrn_init _nrn_init__dcnpas
#define _nrn_initial _nrn_initial__dcnpas
#define nrn_cur _nrn_cur__dcnpas
#define _nrn_current _nrn_current__dcnpas
#define nrn_jacob _nrn_jacob__dcnpas
#define nrn_state _nrn_state__dcnpas
#define _net_receive _net_receive__dcnpas 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_dcnpas", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gbar_dcnpas", 0, 1e+009,
 0,0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
 	...
 	ivoc_help("help ?1 dcnpas D:/Projects/SchreglmannEtAl2020/CCTC_model/modfiles/dcn_pas.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "dcn_pas.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
