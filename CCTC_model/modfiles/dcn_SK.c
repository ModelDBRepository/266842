...
#define nrn_init _nrn_init__dcnSK
#define _nrn_initial _nrn_initial__dcnSK
#define nrn_cur _nrn_cur__dcnSK
#define _nrn_current _nrn_current__dcnSK
#define nrn_jacob _nrn_jacob__dcnSK
#define nrn_state _nrn_state__dcnSK
#define _net_receive _net_receive__dcnSK 
#define _f_rate _f_rate__dcnSK 
#define rate rate__dcnSK 
#define states states__dcnSK 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_dcnSK", _hoc_setdata,
 "rate_dcnSK", _hoc_rate,
 0, 0
};
...
#define qdeltat qdeltat_dcnSK
 double qdeltat = 1;
#define usetable usetable_dcnSK
 double usetable = 1;
 ...
 "qdeltat_dcnSK", &qdeltat_dcnSK,
 "usetable_dcnSK", &usetable_dcnSK,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 dcnSK D:/Projects/SchreglmannEtAl2020/CCTC_model/modfiles/dcn_SK.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "dcn_SK.mod";
static const char* nmodl_file_text = 
