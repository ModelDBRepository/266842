...
#define nrn_init _nrn_init__mcIt
#define _nrn_initial _nrn_initial__mcIt
#define nrn_cur _nrn_cur__mcIt
#define _nrn_current _nrn_current__mcIt
#define nrn_jacob _nrn_jacob__mcIt
#define nrn_state _nrn_state__mcIt
#define _net_receive _net_receive__mcIt 
#define castate castate__mcIt 
#define evaluate_fct evaluate_fct__mcIt 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_mcIt", _hoc_setdata,
 "evaluate_fct_mcIt", _hoc_evaluate_fct,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 mcIt D:/Projects/SchreglmannEtAl2020/CCTC_model/modfiles/mc_IT.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "mc_IT.mod";
static const char* nmodl_file_text = 
