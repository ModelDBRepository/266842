...
#define nrn_init _nrn_init__dcnNaF
#define _nrn_initial _nrn_initial__dcnNaF
#define nrn_cur _nrn_cur__dcnNaF
#define _nrn_current _nrn_current__dcnNaF
#define nrn_jacob _nrn_jacob__dcnNaF
#define nrn_state _nrn_state__dcnNaF
#define _net_receive _net_receive__dcnNaF 
#define _f_rate _f_rate__dcnNaF 
#define rate rate__dcnNaF 
#define states states__dcnNaF 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_dcnNaF", _hoc_setdata,
 "rate_dcnNaF", _hoc_rate,
 0, 0
};
...
#define qdeltat qdeltat_dcnNaF
 double qdeltat = 1;
#define usetable usetable_dcnNaF
 double usetable = 1;
 ...
 "qdeltat_dcnNaF", &qdeltat_dcnNaF,
 "usetable_dcnNaF", &usetable_dcnNaF,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 dcnNaF D:/Projects/SchreglmannEtAl2020/CCTC_model/modfiles/dcn_NaF.mod\n");
...
static int  _f_rate ( _threadargsprotocomma_ double _lv ) {
   if ( fabs ( _lv + 45.0 ) < 1e-6 ) {
     minf = 1.0 / ( 1.0 + exp ( ( _lv + 45.00001 ) / - 7.3 ) ) ;
     }
   else {
...
#if NMODL_TEXT
static const char* nmodl_filename = "dcn_NaF.mod";
static const char* nmodl_file_text = 
