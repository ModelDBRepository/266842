...
#define nrn_init _nrn_init__dcnsKdr
#define _nrn_initial _nrn_initial__dcnsKdr
#define nrn_cur _nrn_cur__dcnsKdr
#define _nrn_current _nrn_current__dcnsKdr
#define nrn_jacob _nrn_jacob__dcnsKdr
#define nrn_state _nrn_state__dcnsKdr
#define _net_receive _net_receive__dcnsKdr 
#define _f_rate _f_rate__dcnsKdr 
#define rate rate__dcnsKdr 
#define states states__dcnsKdr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_dcnsKdr", _hoc_setdata,
 "rate_dcnsKdr", _hoc_rate,
 0, 0
};
...
#define qdeltat qdeltat_dcnsKdr
 double qdeltat = 1;
#define usetable usetable_dcnsKdr
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_dcnsKdr", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gbar_dcnsKdr", "siemens/cm2",
 "ik_dcnsKdr", "mA/cm2",
 0,0
};
 ...
 "qdeltat_dcnsKdr", &qdeltat_dcnsKdr,
 "usetable_dcnsKdr", &usetable_dcnsKdr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 dcnsKdr D:/Projects/SchreglmannEtAl2020/CCTC_model/modfiles/dcn_sKdr.mod\n");
...
static int  _f_rate ( _threadargsprotocomma_ double _lv ) {
   if ( fabs ( _lv + 50.0 ) < 1e-6 ) {
     minf = 1.0 / ( 1.0 + exp ( ( _lv + 50.00001 ) / - 9.1 ) ) ;
     }
   else {
...
#if NMODL_TEXT
static const char* nmodl_filename = "dcn_sKdr.mod";
static const char* nmodl_file_text = 
