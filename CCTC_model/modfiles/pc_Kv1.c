...
#define nrn_init _nrn_init__pcKv1
#define _nrn_initial _nrn_initial__pcKv1
#define nrn_cur _nrn_cur__pcKv1
#define _nrn_current _nrn_current__pcKv1
#define nrn_jacob _nrn_jacob__pcKv1
#define nrn_state _nrn_state__pcKv1
#define _net_receive _net_receive__pcKv1 
#define rates rates__pcKv1 
#define states states__pcKv1 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_pcKv1", _hoc_setdata,
 "alphanfkt_pcKv1", _hoc_alphanfkt,
 "betanfkt_pcKv1", _hoc_betanfkt,
 "rates_pcKv1", _hoc_rates,
 0, 0
};
#define alphanfkt alphanfkt_pcKv1
#define betanfkt betanfkt_pcKv1
 extern double alphanfkt( double );
 extern double betanfkt( double );
 /* declare global and static user variables */
#define ninf ninf_pcKv1
 double ninf = 0;
#define taun taun_pcKv1
 double taun = 0;
 ...
 "ninf_pcKv1", &ninf_pcKv1,
 "taun_pcKv1", &taun_pcKv1,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 pcKv1 D:/Projects/SchreglmannEtAl2020/CCTC_model/modfiles/pc_Kv1.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 90 in file pc_Kv1.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "pc_Kv1.mod";
static const char* nmodl_file_text = 
