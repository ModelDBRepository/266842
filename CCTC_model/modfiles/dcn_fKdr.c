...
#define nrn_init _nrn_init__dcnfKdr
#define _nrn_initial _nrn_initial__dcnfKdr
#define nrn_cur _nrn_cur__dcnfKdr
#define _nrn_current _nrn_current__dcnfKdr
#define nrn_jacob _nrn_jacob__dcnfKdr
#define nrn_state _nrn_state__dcnfKdr
#define _net_receive _net_receive__dcnfKdr 
#define _f_rate _f_rate__dcnfKdr 
#define rate rate__dcnfKdr 
#define states states__dcnfKdr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_dcnfKdr", _hoc_setdata,
 "rate_dcnfKdr", _hoc_rate,
 0, 0
};
...
#define qdeltat qdeltat_dcnfKdr
 double qdeltat = 1;
#define usetable usetable_dcnfKdr
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_dcnfKdr", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gbar_dcnfKdr", "siemens/cm2",
 "ik_dcnfKdr", "mA/cm2",
 0,0
};
 ...
 "qdeltat_dcnfKdr", &qdeltat_dcnfKdr,
 "usetable_dcnfKdr", &usetable_dcnfKdr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 dcnfKdr D:/Projects/SchreglmannEtAl2020/CCTC_model/modfiles/dcn_fKdr.mod\n");
...
static int  _f_rate ( _threadargsprotocomma_ double _lv ) {
   if ( fabs ( _lv + 40.0 ) < 1e-6 ) {
     minf = 1.0 / ( 1.0 + exp ( ( _lv + 40.00001 ) / - 7.8 ) ) ;
     }
   else {
...
#if NMODL_TEXT
static const char* nmodl_filename = "dcn_fKdr.mod";
static const char* nmodl_file_text = 
